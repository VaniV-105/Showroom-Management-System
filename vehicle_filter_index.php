    ...
    <div class="main-contents">
        <div class="topic">
            <div style="float: left; width: 100%;">
                <p><span id="indentation"></span>This page is for Customer use. This page contain search and filter options for vehicles. In this page you can search for a specific vehicle or for a set of vehicles.</p>
            </div>
        </div>
        ...
        <div class="sidebar_vf" style="width: 300px;">
            ...
            <form action="" method="post">
                ...
                <div>
                    <p><b>Vehicle ID : </b></p>
                    <input type="number" id="vehicleid" name="vehicleid" style="height: 20px; width: 125px; border: 2px solid black; border-radius: 5px;" placeholder="Ex . 123456">
                </div>
                <div>
