...
<html>
<head>
    <title>Show Room : Add Employees</title>
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO MYEMPLOYEES VALUES($id, '$name', '$designation', '$qual1', '$qual2', '$qual3', $salary, $contact, '$email', TO_DATE('$doj', 'YYYY-MM-DD'), NULL, TO_DATE('$dob', 'YYYY-MM-DD'), $branch, NULL,'$address')";
